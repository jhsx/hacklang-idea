...
public class HackParser implements PsiParser {
  ...
  public ASTNode parse(IElementType root_, PsiBuilder builder_) {
    ...
    else if (root_ == ADDITIVE_OR_CONCATENATION_EXPR) {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    create_token_set_(ADDITIVE_OR_CONCATENATION_EXPR, ARRAY_LITERAL_EXPR, ASSIGNMENT_EXPR, AWAIT_ASSIGN_EXPR,
      AWAIT_EXPR, AWAIT_LIST_ASSIGN_EXPR, BACKTICKS_EXPR, BITWISE_EXPR,
      CAST_EXPR, CLONE_EXPR, CLOSURE_EXPR, COLLECTION_LITERAL_EXPR,
      COMPARATIVE_EXPR, DIM_EXPR, EXIT_EXPR, EXPR,
      INSTANCEOF_EXPR, INTERNAL_EMPTY_EXPR, INTERNAL_EVAL_EXPR, INTERNAL_INCLUDE_EXPR,
      INTERNAL_ISSET_EXPR, INTERNAL_REQUIRE_EXPR, INTERNAL_TUPLE_EXPR, LAMBDA_EXPR,
      LIST_ASSIGNMENT_EXPR, LITERAL_EXPR, LOGICAL_EXPR, MAP_ARRAY_LITERAL_EXPR,
      MULTIPLICATIVE_EXPR, NEW_EXPR, PARENTHESIZED_EXPR, PREFIX_EXPR,
      PRINT_EXPR, QUERY_ASSIGN_EXPR, QUERY_EXPR, SCALAR_EXPR,
      SHAPE_LITERAL_EXPR, SHIFT_EXPR, STATIC_ADDITIVE_OR_CONCATENATION_EXPR, STATIC_ARRAY_EXPR,
      STATIC_BITWISE_EXPR, STATIC_COMPARATIVE_EXPR, STATIC_EXPR, STATIC_LOGICAL_EXPR,
      STATIC_MULTIPLICATIVE_EXPR, STATIC_PARENTHESIZED_EXPR, STATIC_PREFIX_EXPR, STATIC_SHAPE_EXPR,
      STATIC_SHIFT_EXPR, STATIC_TERNARY_EXPR, TERNARY_EXPR, VARRAY_LITERAL_EXPR,
      XHP_CHILDREN_DECL_EXPR, XHP_CHILDREN_PAREN_EXPR, XHP_EXPR, YIELD_ASSIGN_EXPR,
      YIELD_EXPR, YIELD_LIST_ASSIGN_EXPR),
    ...
    create_token_set_(BLOCK_STATEMENT, BREAK_STATEMENT, CLASS_DECLARATION_STATEMENT, CLASS_STATEMENT,
      ...
      EXPR_STATEMENT, FOREACH_NEW_STATEMENT, FOREACH_STATEMENT, FOR_NEW_STATEMENT,
      FOR_STATEMENT, FUNCTION_DECLARATION_STATEMENT, GLOBAL_STATEMENT, GOTO_STATEMENT,
      HALT_COMPILER_STATEMENT, HH_TYPE_ALIAS_STATEMENT, HTML_STATEMENT, IF_STATEMENT,
      INTERFACE_DECLARATION_STATEMENT, LABEL_STATEMENT, METHOD_FUNCTION_DECLARATION, NAMESPACE_STATEMENT,
      RETURN_STATEMENT, STATEMENT, STATIC_STATEMENT, SWITCH_NEW_STATEMENT,
      SWITCH_STATEMENT, THROW_STATEMENT, TRAIT_DECLARATION_STATEMENT, TRY_STATEMENT,
      UNSET_STATEMENT, USE_STATEMENT, WHILE_NEW_STATEMENT, WHILE_STATEMENT,
      YIELD_STATEMENT),
  };
  ...
  static boolean array_literal_base(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && report_error_(builder_, array_literal_base_2(builder_, level_ + 1)) && result_;
  ...
  // array_pair_list?
  private static boolean array_literal_base_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "array_literal_base_2")) return false;
    array_pair_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean array_literal_expr(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, "<array literal expr>");
  ...
  public static boolean array_pair_list(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && array_pair_list_1(builder_, level_ + 1);
    result_ = result_ && array_pair_list_2(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, ARRAY_PAIR_LIST, result_, false, null);
    return result_;
  }

  // (',' array_pair_item)*
  private static boolean array_pair_list_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "array_pair_list_1")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!array_pair_list_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "array_pair_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' array_pair_item
  private static boolean array_pair_list_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "array_pair_list_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  // ','?
  private static boolean array_pair_list_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "array_pair_list_2")) return false;
  ...
  public static boolean assignment_list(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && assignment_list_1(builder_, level_ + 1);
  ...
  private static boolean assignment_list_0(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = variable(builder_, level_ + 1);
    if (!result_) result_ = assignment_list_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean assignment_list_0_1(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && assignment_list_0_1_2(builder_, level_ + 1);
  ...
  // assignment_list?
  private static boolean assignment_list_0_1_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "assignment_list_0_1_2")) return false;
    assignment_list(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean assignment_list_1(PsiBuilder builder_, int level_) {
    ...
    int pos_ = current_position_(builder_);
    while (true) {
      if (!assignment_list_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "assignment_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' (variable | (T_LIST '(' assignment_list? ')'))
  private static boolean assignment_list_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "assignment_list_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_COMMA);
    result_ = result_ && assignment_list_1_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // variable | (T_LIST '(' assignment_list? ')')
  private static boolean assignment_list_1_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "assignment_list_1_0_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = variable(builder_, level_ + 1);
    if (!result_) result_ = assignment_list_1_0_1_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // T_LIST '(' assignment_list? ')'
  private static boolean assignment_list_1_0_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "assignment_list_1_0_1_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_LIST);
    result_ = result_ && consumeToken(builder_, T_LPAREN);
    result_ = result_ && assignment_list_1_0_1_1_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RPAREN);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // assignment_list?
  private static boolean assignment_list_1_0_1_1_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "assignment_list_1_0_1_1_2")) return false;
    assignment_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean attribute_static_scalar_list(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && attribute_static_scalar_list_1(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RPAREN);
  ...
  // static_scalar_list_ae?
  private static boolean attribute_static_scalar_list_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "attribute_static_scalar_list_1")) return false;
    static_scalar_list_ae(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean await_list_assign_expr(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, consumeToken(builder_, T_LPAREN));
    result_ = pinned_ && report_error_(builder_, await_list_assign_expr_2(builder_, level_ + 1)) && result_;
  ...
  // assignment_list?
  private static boolean await_list_assign_expr_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "await_list_assign_expr_2")) return false;
    assignment_list(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean block_statement_1(PsiBuilder builder_, int level_) {
    ...
    inner_statement_list(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // variable_without_objects | dimmable_variable_access | ('(' variable ')')
  ...
  public static boolean case_block(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && case_block_3(builder_, level_ + 1) && result_;
  ...
  public static boolean case_list(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<case list>", T_CASE, T_DEFAULT)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, "<case list>");
    result_ = case_list_0(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
    ...
    exit_section_(builder_, level_, marker_, CASE_LIST, result_, false, null);
    return result_;
  }
  ...
  /* ********************************************************** */
  // static_class_name T_DOUBLE_COLON (ident|T_CLASS)
  ...
  /* ********************************************************** */
  // user_attributes? (T_CLASS | T_ABSTRACT T_CLASS | T_FINAL T_CLASS) ((ident hh_typevar?)
  ...
  /* ********************************************************** */
  // static_class_name T_DOUBLE_COLON
  ...
  public static boolean class_method_call(PsiBuilder builder_, int level_) {
    ...
    result_ = static_class_name(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_DOUBLE_COLON);
    result_ = result_ && class_method_call_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_LPAREN);
    result_ = result_ && class_method_call_4(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RPAREN);
  ...
  private static boolean class_method_call_2(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = class_method_call_2_0(builder_, level_ + 1);
    if (!result_) result_ = variable_without_objects(builder_, level_ + 1);
    if (!result_) result_ = class_method_call_2_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // ident hh_typeargs_opt?
  private static boolean class_method_call_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "class_method_call_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = ident(builder_, level_ + 1);
    result_ = result_ && class_method_call_2_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // hh_typeargs_opt?
  private static boolean class_method_call_2_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "class_method_call_2_0_1")) return false;
    hh_typeargs_opt(builder_, level_ + 1);
    return true;
  }

  // '{' expr '}'
  private static boolean class_method_call_2_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "class_method_call_2_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_LBRACE);
    result_ = result_ && expr(builder_, level_ + 1);
  ...
  private static boolean class_method_call_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "class_method_call_4")) return false;
    function_call_parameter_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean class_statement(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, "<class statement>");
  ...
  static boolean class_statement_block(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, T_LBRACE);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, class_statement_block_1(builder_, level_ + 1));
    result_ = pinned_ && consumeToken(builder_, T_RBRACE) && result_;
    exit_section_(builder_, level_, marker_, null, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  // class_statement_list?
  private static boolean class_statement_block_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "class_statement_block_1")) return false;
    class_statement_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean closure_expr(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && consumeToken(builder_, T_LPAREN);
    result_ = result_ && closure_expr_4(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RPAREN);
    ...
    result_ = result_ && closure_expr_9(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RBRACE);
  ...
  // parameter_list?
  private static boolean closure_expr_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "closure_expr_4")) return false;
  ...
  // inner_statement_list?
  private static boolean closure_expr_9(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "closure_expr_9")) return false;
    inner_statement_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean collection_literal(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && consumeToken(builder_, T_LBRACE);
    pinned_ = result_; // pin = 2
    result_ = result_ && report_error_(builder_, collection_literal_2(builder_, level_ + 1));
    result_ = pinned_ && consumeToken(builder_, T_RBRACE) && result_;
    exit_section_(builder_, level_, marker_, COLLECTION_LITERAL, result_, pinned_, null);
    return result_ || pinned_;
  }

  // array_pair_list?
  private static boolean collection_literal_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "collection_literal_2")) return false;
    array_pair_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean ctor_arguments(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_LPAREN);
    result_ = result_ && ctor_arguments_1(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RPAREN);
  ...
  // function_call_parameter_list?
  private static boolean ctor_arguments_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "ctor_arguments_1")) return false;
    function_call_parameter_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean declare_new_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, T_COLON);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, declare_new_statement_1(builder_, level_ + 1));
  ...
  // inner_statement_list?
  private static boolean declare_new_statement_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "declare_new_statement_1")) return false;
    inner_statement_list(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // statement | declare_new_statement
  public static boolean declare_statement_body(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = declare_new_statement(builder_, level_ + 1);
  ...
  public static boolean default_case_block(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && default_case_block_2(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, DEFAULT_CASE_BLOCK, result_, pinned_, null);
    return result_ || pinned_;
  }

  // inner_statement_list?
  private static boolean default_case_block_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "default_case_block_2")) return false;
    inner_statement_list(builder_, level_ + 1);
    return true;
  }

  /* ********************************************************** */
  // dim_expr_base '[' expr ']' ('[' expr ']')*
  public static boolean dim_expr(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && expr(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RBRACKET);
    result_ = result_ && dim_expr_4(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, DIM_EXPR, result_, false, null);
    return result_;
  }

  // ('[' expr ']')*
  private static boolean dim_expr_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dim_expr_4")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!dim_expr_4_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "dim_expr_4", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // '[' expr ']'
  private static boolean dim_expr_4_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dim_expr_4_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_LBRACKET);
    result_ = result_ && expr(builder_, level_ + 1);
  ...
  static boolean dimmable_variable_access(PsiBuilder builder_, int level_) {
  ...
  private static boolean dimmable_variable_access_0(PsiBuilder builder_, int level_) {
    ...
    while (result_) {
      ...
      if (!empty_element_parsed_guard_(builder_, "dimmable_variable_access_0", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  public static boolean elseif_list(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = elseif_body(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
    ...
    exit_section_(builder_, marker_, ELSEIF_LIST, result_);
    return result_;
  }
  ...
  private static boolean encaps_list_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = encaps_list_0_0(builder_, level_ + 1);
  ...
  private static boolean encaps_list_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "encaps_list_0_0")) return false;
    consumeToken(builder_, T_ENCAPSED_AND_WHITESPACE);
    return true;
  }
  ...
  /* ********************************************************** */
  // user_attributes? T_ENUM ident  ':' hh_type (T_AS hh_type)? '{' enum_statement_list? '}'
  public static boolean enum_declaration_statement(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 2
    result_ = result_ && report_error_(builder_, ident(builder_, level_ + 1));
    ...
    result_ = pinned_ && report_error_(builder_, enum_declaration_statement_7(builder_, level_ + 1)) && result_;
    result_ = pinned_ && consumeToken(builder_, T_RBRACE) && result_;
  ...
  // enum_statement_list?
  private static boolean enum_declaration_statement_7(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "enum_declaration_statement_7")) return false;
    enum_statement_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean enum_statement_list(PsiBuilder builder_, int level_) {
    ...
    result_ = enum_statement(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
    ...
    exit_section_(builder_, level_, marker_, ENUM_STATEMENT_LIST, result_, false, null);
    return result_;
  }
  ...
  public static boolean expr(PsiBuilder builder_, int level_) {
    ...
    result_ = assignment_expr_wrapper(builder_, level_ + 1);
  ...
  static boolean expr_with_parens(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = expr_with_parens_base(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // '(' expr_with_parens ')'
  static boolean expr_with_parens_base(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "expr_with_parens_base")) return false;
    if (!nextTokenIs(builder_, T_LPAREN)) return false;
    boolean result_;
    boolean pinned_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, null);
    result_ = consumeToken(builder_, T_LPAREN);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, expr_with_parens(builder_, level_ + 1));
    result_ = pinned_ && consumeToken(builder_, T_RPAREN) && result_;
    exit_section_(builder_, level_, marker_, null, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  public static boolean for_new_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, T_COLON);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, for_new_statement_1(builder_, level_ + 1));
  ...
  // inner_statement_list?
  private static boolean for_new_statement_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "for_new_statement_1")) return false;
    inner_statement_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean for_statement_body(PsiBuilder builder_, int level_) {
    ...
    result_ = statement(builder_, level_ + 1);
    if (!result_) result_ = for_new_statement(builder_, level_ + 1);
  ...
  public static boolean foreach_new_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, T_COLON);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, foreach_new_statement_1(builder_, level_ + 1));
  ...
  // inner_statement_list?
  private static boolean foreach_new_statement_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "foreach_new_statement_1")) return false;
    inner_statement_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean foreach_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && report_error_(builder_, foreach_optional_arg(builder_, level_ + 1)) && result_;
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, T_RPAREN)) && result_;
  ...
  /* ********************************************************** */
  // statement | foreach_new_statement
  public static boolean foreach_statement_body(PsiBuilder builder_, int level_) {
    ...
    result_ = statement(builder_, level_ + 1);
    if (!result_) result_ = foreach_new_statement(builder_, level_ + 1);
  ...
  public static boolean function_call_parameter_list(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && function_call_parameter_list_1(builder_, level_ + 1);
    result_ = result_ && function_call_parameter_list_2(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, FUNCTION_CALL_PARAMETER_LIST, result_, false, null);
    return result_;
  }

  // (',' calling_parameter_item)*
  private static boolean function_call_parameter_list_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "function_call_parameter_list_1")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!function_call_parameter_list_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "function_call_parameter_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' calling_parameter_item
  private static boolean function_call_parameter_list_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "function_call_parameter_list_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_COMMA);
  ...
  // ','?
  private static boolean function_call_parameter_list_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "function_call_parameter_list_2")) return false;
    consumeToken(builder_, T_COMMA);
    return true;
  }

  /* ********************************************************** */
  // user_attributes? method_modifiers? T_FUNCTION '&'? ident hh_typevar?  '(' parameter_list? ')' hh_opt_return_type? function_body
  public static boolean function_declaration_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && report_error_(builder_, ident(builder_, level_ + 1)) && result_;
    ...
    result_ = pinned_ && report_error_(builder_, function_declaration_statement_7(builder_, level_ + 1)) && result_;
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, T_RPAREN)) && result_;
  ...
  // parameter_list?
  private static boolean function_declaration_statement_7(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "function_declaration_statement_7")) return false;
    parameter_list(builder_, level_ + 1);
    return true;
  }
  ...
  static boolean hackFile(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && hackFile_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // top_statement_list?
  private static boolean hackFile_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hackFile_1")) return false;
  ...
  private static boolean hh_func_type_list_0(PsiBuilder builder_, int level_) {
    ...
    hh_type_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean hh_function_type(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 2
    result_ = result_ && report_error_(builder_, consumeToken(builder_, T_LPAREN));
    result_ = pinned_ && report_error_(builder_, hh_function_type_3(builder_, level_ + 1)) && result_;
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, T_RPAREN)) && result_;
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, T_COLON)) && result_;
    result_ = pinned_ && report_error_(builder_, hh_type(builder_, level_ + 1)) && result_;
    result_ = pinned_ && consumeToken(builder_, T_RPAREN) && result_;
  ...
  // hh_func_type_list?
  private static boolean hh_function_type_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hh_function_type_3")) return false;
    hh_func_type_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean hh_shape_member_list(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && hh_shape_member_list_1(builder_, level_ + 1);
    result_ = result_ && hh_shape_member_list_2(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, HH_SHAPE_MEMBER_LIST, result_, false, null);
    return result_;
  }

  // (',' hh_shape_member_type)*
  private static boolean hh_shape_member_list_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hh_shape_member_list_1")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!hh_shape_member_list_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "hh_shape_member_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' hh_shape_member_type
  private static boolean hh_shape_member_list_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hh_shape_member_list_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_COMMA);
  ...
  // ','?
  private static boolean hh_shape_member_list_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hh_shape_member_list_2")) return false;
    consumeToken(builder_, T_COMMA);
    return true;
  }
  ...
  public static boolean hh_shape_type(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, consumeToken(builder_, T_LPAREN));
    result_ = pinned_ && report_error_(builder_, hh_shape_type_2(builder_, level_ + 1)) && result_;
    result_ = pinned_ && consumeToken(builder_, T_RPAREN) && result_;
  ...
  private static boolean hh_shape_type_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hh_shape_type_2")) return false;
    hh_shape_member_list(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // (T_TYPE ident hh_typevar? '=' hh_type ';')
  ...
  private static boolean hh_type_alias_statement_0(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && ident(builder_, level_ + 1);
    result_ = result_ && hh_type_alias_statement_0_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_EQUAL);
    result_ = result_ && hh_type(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_SEMICOLON);
    exit_section_(builder_, marker_, null, result_);
  ...
  // hh_typevar?
  private static boolean hh_type_alias_statement_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hh_type_alias_statement_0_2")) return false;
    hh_typevar(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean hh_type_alias_statement_1(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && ident(builder_, level_ + 1);
    result_ = result_ && hh_type_alias_statement_1_2(builder_, level_ + 1);
    result_ = result_ && hh_type_alias_statement_1_3(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_EQUAL);
    result_ = result_ && hh_type(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_SEMICOLON);
    exit_section_(builder_, marker_, null, result_);
  ...
  // hh_typevar?
  private static boolean hh_type_alias_statement_1_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hh_type_alias_statement_1_2")) return false;
    hh_typevar(builder_, level_ + 1);
    return true;
  }

  // (T_AS hh_type)?
  private static boolean hh_type_alias_statement_1_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hh_type_alias_statement_1_3")) return false;
    hh_type_alias_statement_1_3_0(builder_, level_ + 1);
    return true;
  }

  // T_AS hh_type
  private static boolean hh_type_alias_statement_1_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hh_type_alias_statement_1_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_AS);
    result_ = result_ && hh_type(builder_, level_ + 1);
  ...
  public static boolean hh_type_list(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && hh_type_list_1(builder_, level_ + 1);
    result_ = result_ && hh_type_list_2(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, HH_TYPE_LIST, result_, false, null);
    return result_;
  }

  // (',' hh_type)*
  private static boolean hh_type_list_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hh_type_list_1")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!hh_type_list_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "hh_type_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' hh_type
  private static boolean hh_type_list_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hh_type_list_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_COMMA);
    result_ = result_ && hh_type(builder_, level_ + 1);
  ...
  // ','?
  private static boolean hh_type_list_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hh_type_list_2")) return false;
    consumeToken(builder_, T_COMMA);
    return true;
  }
  ...
  public static boolean hh_typeargs_opt(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, hh_typeargs_opt_1(builder_, level_ + 1));
  ...
  // hh_type_list?
  private static boolean hh_typeargs_opt_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hh_typeargs_opt_1")) return false;
    hh_type_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean hh_typevar(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, T_TYPELIST_LT);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, hh_typevar_1(builder_, level_ + 1));
    result_ = pinned_ && consumeToken(builder_, T_TYPELIST_GT) && result_;
  ...
  // hh_typevar_list?
  private static boolean hh_typevar_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hh_typevar_1")) return false;
    hh_typevar_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean hh_typevar_list(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && hh_typevar_list_1(builder_, level_ + 1);
  ...
  private static boolean hh_typevar_list_1(PsiBuilder builder_, int level_) {
    ...
    hh_typevar_list_1_0(builder_, level_ + 1);
    return true;
  }

  // ',' hh_typevar_item
  private static boolean hh_typevar_list_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "hh_typevar_list_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_COMMA);
  ...
  /* ********************************************************** */
  // normal_if_statement |  new_if_statement
  public static boolean if_statement(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = normal_if_statement(builder_, level_ + 1);
    if (!result_) result_ = new_if_statement(builder_, level_ + 1);
  ...
  public static boolean inner_statement_list(PsiBuilder builder_, int level_) {
    ...
    result_ = inner_statement(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
    ...
    exit_section_(builder_, level_, marker_, INNER_STATEMENT_LIST, result_, false, null);
    return result_;
  }
  ...
  /* ********************************************************** */
  // user_attributes? T_INTERFACE ident hh_typevar?  interface_extends_list? class_statement_block
  ...
  private static boolean interface_list_1(PsiBuilder builder_, int level_) {
    ...
    int pos_ = current_position_(builder_);
    while (true) {
      if (!interface_list_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "interface_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' fully_qualified_class_name
  private static boolean interface_list_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "interface_list_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_COMMA);
    result_ = result_ && fully_qualified_class_name(builder_, level_ + 1);
  ...
  public static boolean internal_include_expr(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    boolean pinned_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, "<internal include expr>");
  ...
  public static boolean internal_require_expr(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    boolean pinned_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, "<internal require expr>");
  ...
  public static boolean internal_tuple_expr(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, consumeToken(builder_, T_LPAREN));
    result_ = pinned_ && report_error_(builder_, internal_tuple_expr_2(builder_, level_ + 1)) && result_;
    result_ = pinned_ && consumeToken(builder_, T_RPAREN) && result_;
  ...
  // function_call_parameter_list?
  private static boolean internal_tuple_expr_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "internal_tuple_expr_2")) return false;
    function_call_parameter_list(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean lambda_expr_1_1(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && lambda_expr_1_1_1(builder_, level_ + 1);
  ...
  // parameter_list?
  private static boolean lambda_expr_1_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "lambda_expr_1_1_1")) return false;
    parameter_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean lambda_use_vars(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, consumeToken(builder_, T_LPAREN));
    result_ = pinned_ && report_error_(builder_, lambda_use_vars_2(builder_, level_ + 1)) && result_;
    result_ = pinned_ && consumeToken(builder_, T_RPAREN) && result_;
  ...
  // lexical_var_list?
  private static boolean lambda_use_vars_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "lambda_use_vars_2")) return false;
    lexical_var_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean lexical_var_list(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && lexical_var_list_2(builder_, level_ + 1);
    result_ = result_ && lexical_var_list_3(builder_, level_ + 1);
  ...
  // (',' '&' T_VARIABLE)*
  private static boolean lexical_var_list_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "lexical_var_list_2")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!lexical_var_list_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "lexical_var_list_2", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' '&' T_VARIABLE
  private static boolean lexical_var_list_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "lexical_var_list_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_COMMA);
  ...
  public static boolean list_assignment_expr(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, consumeToken(builder_, T_LPAREN));
    result_ = pinned_ && report_error_(builder_, list_assignment_expr_2(builder_, level_ + 1)) && result_;
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, T_RPAREN)) && result_;
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, T_EQUAL)) && result_;
  ...
  // assignment_list?
  private static boolean list_assignment_expr_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "list_assignment_expr_2")) return false;
    assignment_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean literal_expr(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, "<literal expr>");
  ...
  /* ********************************************************** */
  // variable
  static boolean literal_ident_expr(PsiBuilder builder_, int level_) {
  ...
  public static boolean map_array_literal_expr(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    boolean pinned_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, "<map array literal expr>");
    result_ = map_array_literal_expr_0(builder_, level_ + 1);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, consumeToken(builder_, T_LPAREN));
    result_ = pinned_ && report_error_(builder_, map_array_literal_expr_2(builder_, level_ + 1)) && result_;
    result_ = pinned_ && consumeToken(builder_, T_RPAREN) && result_;
  ...
  // array_pair_list?
  private static boolean map_array_literal_expr_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "map_array_literal_expr_2")) return false;
    array_pair_list(builder_, level_ + 1);
    return true;
  }
  ...
  //                     | T_FINAL
  //                     | T_ASYNC
  static boolean member_modifier(PsiBuilder builder_, int level_) {
  ...
  public static boolean method_function_declaration(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && consumeToken(builder_, T_LPAREN);
    result_ = result_ && method_function_declaration_7(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RPAREN);
  ...
  // parameter_list?
  private static boolean method_function_declaration_7(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_function_declaration_7")) return false;
    parameter_list(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean namespace_statement_1(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_NAMESPACE);
    result_ = result_ && namespace_statement_1_1(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_LBRACE);
    result_ = result_ && namespace_statement_1_3(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RBRACE);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // namespace_name?
  private static boolean namespace_statement_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "namespace_statement_1_1")) return false;
    namespace_name(builder_, level_ + 1);
    return true;
  }

  // top_statement_list?
  private static boolean namespace_statement_1_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "namespace_statement_1_3")) return false;
    top_statement_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean new_else_single(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && new_else_single_2(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, NEW_ELSE_SINGLE, result_, pinned_, null);
    return result_ || pinned_;
  }

  // inner_statement_list?
  private static boolean new_else_single_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "new_else_single_2")) return false;
    inner_statement_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean new_elseif_body(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && report_error_(builder_, parenthesized_expr(builder_, level_ + 1));
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, T_COLON)) && result_;
    result_ = pinned_ && new_elseif_body_3(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, NEW_ELSEIF_BODY, result_, pinned_, null);
    return result_ || pinned_;
  }

  // inner_statement_list?
  private static boolean new_elseif_body_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "new_elseif_body_3")) return false;
    inner_statement_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean new_elseif_list(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = new_elseif_body(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
    ...
    exit_section_(builder_, marker_, NEW_ELSEIF_LIST, result_);
    return result_;
  }
  ...
  static boolean new_if_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && consumeToken(builder_, T_COLON);
    pinned_ = result_; // pin = 3
    result_ = result_ && report_error_(builder_, new_if_statement_3(builder_, level_ + 1));
    result_ = pinned_ && report_error_(builder_, new_if_statement_4(builder_, level_ + 1)) && result_;
  ...
  // inner_statement_list?
  private static boolean new_if_statement_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "new_if_statement_3")) return false;
    inner_statement_list(builder_, level_ + 1);
    return true;
  }

  // new_elseif_list?
  private static boolean new_if_statement_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "new_if_statement_4")) return false;
    new_elseif_list(builder_, level_ + 1);
    return true;
  }
  ...
  static boolean normal_if_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && report_error_(builder_, normal_if_statement_3(builder_, level_ + 1)) && result_;
  ...
  // elseif_list?
  private static boolean normal_if_statement_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "normal_if_statement_3")) return false;
    elseif_list(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // (variable|expr_with_parens_base) T_OBJECT_OPERATOR
  //                                     ((ident hh_typeargs_opt?)|variable_without_objects|('{' expr '}'))
  //                                         '(' function_call_parameter_list? ')'
  public static boolean object_method_call(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && object_method_call_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_LPAREN);
    result_ = result_ && object_method_call_4(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RPAREN);
    exit_section_(builder_, level_, marker_, OBJECT_METHOD_CALL, result_, false, null);
    return result_;
  }

  // variable|expr_with_parens_base
  private static boolean object_method_call_0(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = variable(builder_, level_ + 1);
    if (!result_) result_ = expr_with_parens_base(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean object_method_call_2(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = object_method_call_2_0(builder_, level_ + 1);
    if (!result_) result_ = variable_without_objects(builder_, level_ + 1);
    if (!result_) result_ = object_method_call_2_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // ident hh_typeargs_opt?
  private static boolean object_method_call_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "object_method_call_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = ident(builder_, level_ + 1);
    result_ = result_ && object_method_call_2_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // hh_typeargs_opt?
  private static boolean object_method_call_2_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "object_method_call_2_0_1")) return false;
    hh_typeargs_opt(builder_, level_ + 1);
    return true;
  }

  // '{' expr '}'
  private static boolean object_method_call_2_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "object_method_call_2_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_LBRACE);
    result_ = result_ && expr(builder_, level_ + 1);
  ...
  public static boolean parameter_list(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && parameter_list_2(builder_, level_ + 1);
  ...
  static boolean primary_expr(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = parenthesized_expr(builder_, level_ + 1);
    ...
    if (!result_) result_ = literal_ident_expr(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // property_access_without_variables | (T_OBJECT_OPERATOR variable_without_objects)
  ...
  static boolean property_access_without_variables(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_OBJECT_OPERATOR);
    result_ = result_ && property_access_without_variables_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean property_access_without_variables_1(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = ident(builder_, level_ + 1);
    if (!result_) result_ = property_access_without_variables_1_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // '{' expr '}'
  private static boolean property_access_without_variables_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "property_access_without_variables_1_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_LBRACE);
    result_ = result_ && expr(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // compound_variable (('[' expr ']')|('{' expr '}')|compound_variable)*
  ...
  public static boolean scalar_expr(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, "<scalar expr>");
    ...
    if (!result_) result_ = scalar_expr_4(builder_, level_ + 1);
    if (!result_) result_ = scalar_expr_5(builder_, level_ + 1);
    if (!result_) result_ = scalar_expr_6(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, SCALAR_EXPR, result_, false, null);
    return result_;
  }

  // '"' encaps_list '"'
  private static boolean scalar_expr_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "scalar_expr_4")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  // "'" encaps_list "'"
  private static boolean scalar_expr_5(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "scalar_expr_5")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  // T_START_HEREDOC encaps_list T_END_HEREDOC
  private static boolean scalar_expr_6(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "scalar_expr_6")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  public static boolean shape_literal_expr(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && consumeToken(builder_, T_LPAREN);
    pinned_ = result_; // pin = 2
    result_ = result_ && report_error_(builder_, shape_literal_expr_2(builder_, level_ + 1));
    result_ = pinned_ && consumeToken(builder_, T_RPAREN) && result_;
  ...
  // shape_pair_list?
  private static boolean shape_literal_expr_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "shape_literal_expr_2")) return false;
    shape_pair_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean shape_pair_list(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && shape_pair_list_1(builder_, level_ + 1);
    result_ = result_ && shape_pair_list_2(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, SHAPE_PAIR_LIST, result_, false, null);
    return result_;
  }

  // (',' shape_pair)*
  private static boolean shape_pair_list_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "shape_pair_list_1")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!shape_pair_list_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "shape_pair_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' shape_pair
  private static boolean shape_pair_list_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "shape_pair_list_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_COMMA);
  ...
  // ','?
  private static boolean shape_pair_list_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "shape_pair_list_2")) return false;
    consumeToken(builder_, T_COMMA);
    return true;
  }
  ...
  static boolean short_array_literal_base(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, T_LBRACKET);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, short_array_literal_base_1(builder_, level_ + 1));
  ...
  // array_pair_list?
  private static boolean short_array_literal_base_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "short_array_literal_base_1")) return false;
    array_pair_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean simple_function_call(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && consumeToken(builder_, T_LPAREN);
    pinned_ = result_; // pin = 2
    result_ = result_ && report_error_(builder_, simple_function_call_2(builder_, level_ + 1));
    result_ = pinned_ && consumeToken(builder_, T_RPAREN) && result_;
    exit_section_(builder_, level_, marker_, SIMPLE_FUNCTION_CALL, result_, pinned_, null);
    return result_ || pinned_;
  }

  // function_call_parameter_list?
  private static boolean simple_function_call_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "simple_function_call_2")) return false;
    function_call_parameter_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean static_array_expr(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, "<static array expr>");
  ...
  private static boolean static_array_expr_0(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, T_ARRAY);
    result_ = result_ && consumeToken(builder_, T_LPAREN);
    result_ = result_ && static_array_expr_0_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RPAREN);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean static_array_expr_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_array_expr_0_2")) return false;
    static_array_pair_list(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean static_array_expr_1(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_LBRACKET);
    result_ = result_ && static_array_expr_1_1(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RBRACKET);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // static_array_pair_list?
  private static boolean static_array_expr_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_array_expr_1_1")) return false;
    static_array_pair_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean static_array_pair_list(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && static_array_pair_list_1(builder_, level_ + 1);
    result_ = result_ && static_array_pair_list_2(builder_, level_ + 1);
    result_ = result_ && static_array_pair_list_3(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, STATIC_ARRAY_PAIR_LIST, result_, false, null);
    return result_;
  }

  // (',' static_array_item)*
  private static boolean static_array_pair_list_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_array_pair_list_1")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!static_array_pair_list_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "static_array_pair_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' static_array_item
  private static boolean static_array_pair_list_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_array_pair_list_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_COMMA);
  ...
  // ','?
  private static boolean static_array_pair_list_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_array_pair_list_2")) return false;
    consumeToken(builder_, T_COMMA);
    return true;
  }

  // ','?
  private static boolean static_array_pair_list_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_array_pair_list_3")) return false;
    consumeToken(builder_, T_COMMA);
    return true;
  }
  ...
  public static boolean static_array_pair_list_ae(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && static_array_pair_list_ae_1(builder_, level_ + 1);
    result_ = result_ && static_array_pair_list_ae_2(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, STATIC_ARRAY_PAIR_LIST_AE, result_, false, null);
    return result_;
  }

  // (',' static_array_item_ae)*
  private static boolean static_array_pair_list_ae_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_array_pair_list_ae_1")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!static_array_pair_list_ae_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "static_array_pair_list_ae_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' static_array_item_ae
  private static boolean static_array_pair_list_ae_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_array_pair_list_ae_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_COMMA);
  ...
  // ','?
  private static boolean static_array_pair_list_ae_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_array_pair_list_ae_2")) return false;
    consumeToken(builder_, T_COMMA);
    return true;
  }
  ...
  public static boolean static_collection_literal(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && consumeToken(builder_, T_LBRACE);
    pinned_ = result_; // pin = 2
    result_ = result_ && report_error_(builder_, static_collection_literal_2(builder_, level_ + 1));
    result_ = pinned_ && consumeToken(builder_, T_RBRACE) && result_;
  ...
  // static_array_pair_list?
  private static boolean static_collection_literal_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_collection_literal_2")) return false;
    static_array_pair_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean static_expr(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, "<static expr>");
  ...
  public static boolean static_map_array_literal(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, consumeToken(builder_, T_LPAREN));
    result_ = pinned_ && report_error_(builder_, static_map_array_literal_2(builder_, level_ + 1)) && result_;
    result_ = pinned_ && consumeToken(builder_, T_RPAREN) && result_;
  ...
  // static_array_pair_list?
  private static boolean static_map_array_literal_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_map_array_literal_2")) return false;
    static_array_pair_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean static_prefix_expr(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, "<static prefix expr>");
  ...
  private static boolean static_scalar_ae_3(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, T_ARRAY);
    result_ = result_ && consumeToken(builder_, T_LPAREN);
    result_ = result_ && static_scalar_ae_3_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RPAREN);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // static_array_pair_list_ae?
  private static boolean static_scalar_ae_3_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_scalar_ae_3_2")) return false;
    static_array_pair_list_ae(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean static_scalar_ae_4(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_LBRACKET);
    result_ = result_ && static_scalar_ae_4_1(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RBRACKET);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // static_array_pair_list_ae?
  private static boolean static_scalar_ae_4_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_scalar_ae_4_1")) return false;
    static_array_pair_list_ae(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean static_scalar_ae_5(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, T_SHAPE);
    result_ = result_ && consumeToken(builder_, T_LPAREN);
    result_ = result_ && static_scalar_ae_5_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RPAREN);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean static_scalar_ae_5_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_scalar_ae_5_2")) return false;
    static_shape_pair_list_ae(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean static_scalar_list_ae(PsiBuilder builder_, int level_) {
    ...
    result_ = static_scalar_ae(builder_, level_ + 1);
    result_ = result_ && static_scalar_list_ae_1(builder_, level_ + 1);
    result_ = result_ && static_scalar_list_ae_2(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, STATIC_SCALAR_LIST_AE, result_, false, null);
    return result_;
  }

  // (',' static_scalar_ae)*
  private static boolean static_scalar_list_ae_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_scalar_list_ae_1")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!static_scalar_list_ae_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "static_scalar_list_ae_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' static_scalar_ae
  private static boolean static_scalar_list_ae_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_scalar_list_ae_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_COMMA);
    result_ = result_ && static_scalar_ae(builder_, level_ + 1);
  ...
  // ','?
  private static boolean static_scalar_list_ae_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_scalar_list_ae_2")) return false;
    consumeToken(builder_, T_COMMA);
    return true;
  }
  ...
  public static boolean static_shape_expr(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && consumeToken(builder_, T_LPAREN);
    pinned_ = result_; // pin = 2
    result_ = result_ && report_error_(builder_, static_shape_expr_2(builder_, level_ + 1));
    result_ = pinned_ && consumeToken(builder_, T_RPAREN) && result_;
  ...
  private static boolean static_shape_expr_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_shape_expr_2")) return false;
    static_shape_pair_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean static_shape_pair_list(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && static_shape_pair_list_1(builder_, level_ + 1);
    result_ = result_ && static_shape_pair_list_2(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, STATIC_SHAPE_PAIR_LIST, result_, false, null);
    return result_;
  }

  // (',' shape_pair_static)*
  private static boolean static_shape_pair_list_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_shape_pair_list_1")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!static_shape_pair_list_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "static_shape_pair_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' shape_pair_static
  private static boolean static_shape_pair_list_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_shape_pair_list_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_COMMA);
  ...
  // ','?
  private static boolean static_shape_pair_list_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_shape_pair_list_2")) return false;
    consumeToken(builder_, T_COMMA);
    return true;
  }
  ...
  public static boolean static_shape_pair_list_ae(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && static_shape_pair_list_ae_1(builder_, level_ + 1);
    result_ = result_ && static_shape_pair_list_ae_2(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, STATIC_SHAPE_PAIR_LIST_AE, result_, false, null);
    return result_;
  }

  // (',' static_shape_pair_item)*
  private static boolean static_shape_pair_list_ae_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_shape_pair_list_ae_1")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!static_shape_pair_list_ae_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "static_shape_pair_list_ae_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' static_shape_pair_item
  private static boolean static_shape_pair_list_ae_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_shape_pair_list_ae_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_COMMA);
  ...
  // ','?
  private static boolean static_shape_pair_list_ae_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_shape_pair_list_ae_2")) return false;
    consumeToken(builder_, T_COMMA);
    return true;
  }
  ...
  public static boolean static_varray_literal(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, consumeToken(builder_, T_LPAREN));
    result_ = pinned_ && report_error_(builder_, static_varray_literal_2(builder_, level_ + 1)) && result_;
    result_ = pinned_ && consumeToken(builder_, T_RPAREN) && result_;
  ...
  // static_array_pair_list?
  private static boolean static_varray_literal_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "static_varray_literal_2")) return false;
    static_array_pair_list(builder_, level_ + 1);
    return true;
  }

  /* ********************************************************** */
  // switch_statament_list | switch_new_statement
  public static boolean switch_case_list(PsiBuilder builder_, int level_) {
    ...
    result_ = switch_statament_list(builder_, level_ + 1);
  ...
  public static boolean switch_new_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && report_error_(builder_, switch_new_statement_2(builder_, level_ + 1)) && result_;
  ...
  // case_list?
  private static boolean switch_new_statement_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "switch_new_statement_2")) return false;
    case_list(builder_, level_ + 1);
    return true;
  }

  /* ********************************************************** */
  // '{' ';'? case_list? '}'
  static boolean switch_statament_list(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "switch_statament_list")) return false;
    if (!nextTokenIs(builder_, T_LBRACE)) return false;
    boolean result_;
    boolean pinned_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, null);
    result_ = consumeToken(builder_, T_LBRACE);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, switch_statament_list_1(builder_, level_ + 1));
    result_ = pinned_ && report_error_(builder_, switch_statament_list_2(builder_, level_ + 1)) && result_;
    result_ = pinned_ && consumeToken(builder_, T_RBRACE) && result_;
    exit_section_(builder_, level_, marker_, null, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  // ';'?
  private static boolean switch_statament_list_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "switch_statament_list_1")) return false;
    consumeToken(builder_, T_SEMICOLON);
    return true;
  }

  // case_list?
  private static boolean switch_statament_list_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "switch_statament_list_2")) return false;
    case_list(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // user_attributes? T_TRAIT ident hh_typevar?  implements_list? class_statement_block
  ...
  public static boolean trait_list(PsiBuilder builder_, int level_) {
    ...
    result_ = fully_qualified_class_name(builder_, level_ + 1);
    result_ = result_ && trait_list_1(builder_, level_ + 1);
  ...
  private static boolean trait_list_1(PsiBuilder builder_, int level_) {
    ...
    int pos_ = current_position_(builder_);
    while (true) {
      if (!trait_list_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "trait_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' fully_qualified_class_name
  private static boolean trait_list_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "trait_list_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_COMMA);
    result_ = result_ && fully_qualified_class_name(builder_, level_ + 1);
  ...
  public static boolean try_catch(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, T_RPAREN)) && result_;
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, T_LBRACE)) && result_;
    result_ = pinned_ && report_error_(builder_, try_catch_6(builder_, level_ + 1)) && result_;
    result_ = pinned_ && consumeToken(builder_, T_RBRACE) && result_;
  ...
  // inner_statement_list?
  private static boolean try_catch_6(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "try_catch_6")) return false;
    inner_statement_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean use_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, T_USE);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, use_statement_1(builder_, level_ + 1));
    result_ = pinned_ && report_error_(builder_, use_declarations(builder_, level_ + 1)) && result_;
    result_ = pinned_ && consumeToken(builder_, T_SEMICOLON) && result_;
    exit_section_(builder_, level_, marker_, USE_STATEMENT, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  private static boolean use_statement_1(PsiBuilder builder_, int level_) {
    ...
    use_statement_1_0(builder_, level_ + 1);
    return true;
  }

  // T_FUNCTION | T_CONST
  private static boolean use_statement_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "use_statement_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  public static boolean user_attribute_list(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && user_attribute_list_1(builder_, level_ + 1);
    result_ = result_ && user_attribute_list_2(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, USER_ATTRIBUTE_LIST, result_, false, null);
    return result_;
  }

  // (',' user_attribute)*
  private static boolean user_attribute_list_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "user_attribute_list_1")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!user_attribute_list_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "user_attribute_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' user_attribute
  private static boolean user_attribute_list_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "user_attribute_list_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_COMMA);
  ...
  // ','?
  private static boolean user_attribute_list_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "user_attribute_list_2")) return false;
    consumeToken(builder_, T_COMMA);
    return true;
  }
  ...
  public static boolean user_attributes(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_SL);
    result_ = result_ && user_attributes_1(builder_, level_ + 1);
  ...
  // user_attribute_list?
  private static boolean user_attributes_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "user_attributes_1")) return false;
    user_attribute_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean variable(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && variable_1(builder_, level_ + 1);
  ...
  private static boolean variable_0(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = dimmable_variable_access(builder_, level_ + 1);
    if (!result_) result_ = variable_0_5(builder_, level_ + 1);
    if (!result_) result_ = variable_0_6(builder_, level_ + 1);
    if (!result_) result_ = variable_0_7(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // static_class_name T_DOUBLE_COLON variable_without_objects
  private static boolean variable_0_5(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "variable_0_5")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = static_class_name(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_DOUBLE_COLON);
  ...
  // callable_variable '(' function_call_parameter_list? ')'
  private static boolean variable_0_6(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "variable_0_6")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = callable_variable(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_LPAREN);
    result_ = result_ && variable_0_6_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, T_RPAREN);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // function_call_parameter_list?
  private static boolean variable_0_6_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "variable_0_6_2")) return false;
    function_call_parameter_list(builder_, level_ + 1);
    return true;
  }

  // '(' variable ')'
  private static boolean variable_0_7(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "variable_0_7")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, T_LPAREN);
    result_ = result_ && variable(builder_, level_ + 1);
  ...
  private static boolean variable_1(PsiBuilder builder_, int level_) {
    ...
    int pos_ = current_position_(builder_);
    while (true) {
      if (!property_access(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "variable_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean variable_without_objects(PsiBuilder builder_, int level_) {
    ...
    result_ = variable_without_objects_0(builder_, level_ + 1);
  ...
  // '$'*
  private static boolean variable_without_objects_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "variable_without_objects_0")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!consumeToken(builder_, T_DOLLAR_SIGN)) break;
      if (!empty_element_parsed_guard_(builder_, "variable_without_objects_0", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean varray_literal_expr(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, consumeToken(builder_, T_LPAREN));
    result_ = pinned_ && report_error_(builder_, varray_literal_expr_2(builder_, level_ + 1)) && result_;
    result_ = pinned_ && consumeToken(builder_, T_RPAREN) && result_;
  ...
  // array_pair_list?
  private static boolean varray_literal_expr_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "varray_literal_expr_2")) return false;
    array_pair_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean while_new_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, T_COLON);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, while_new_statement_1(builder_, level_ + 1));
  ...
  // inner_statement_list?
  private static boolean while_new_statement_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "while_new_statement_1")) return false;
    inner_statement_list(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean while_statement_body(PsiBuilder builder_, int level_) {
    ...
    result_ = statement(builder_, level_ + 1);
    if (!result_) result_ = while_new_statement(builder_, level_ + 1);
  ...
  public static boolean xhp_children_decl_expr(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, "<xhp children decl expr>");
  ...
  public static boolean yield_list_assign_expr(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, consumeToken(builder_, T_LPAREN));
    result_ = pinned_ && report_error_(builder_, yield_list_assign_expr_2(builder_, level_ + 1)) && result_;
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, T_RPAREN)) && result_;
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, T_EQUAL)) && result_;
  ...
  // assignment_list?
  private static boolean yield_list_assign_expr_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "yield_list_assign_expr_2")) return false;
    assignment_list(builder_, level_ + 1);
    return true;
  }
