...
public class HackEmptyExpressionImpl extends HackExpressionImpl implements HackEmptyExpression {

  public HackEmptyExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitEmptyExpression(this);
