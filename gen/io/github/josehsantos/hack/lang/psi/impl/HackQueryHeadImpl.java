...
public class HackQueryHeadImpl extends ASTWrapperPsiElement implements HackQueryHead {

  public HackQueryHeadImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitQueryHead(this);
