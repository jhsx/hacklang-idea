...
public class HackStaticExpressionImpl extends HackExpressionImpl implements HackStaticExpression {

  public HackStaticExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitStaticExpression(this);
