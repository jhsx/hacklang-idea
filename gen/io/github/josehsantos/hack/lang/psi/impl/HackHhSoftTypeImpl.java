...
public class HackHhSoftTypeImpl extends ASTWrapperPsiElement implements HackHhSoftType {

  public HackHhSoftTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitHhSoftType(this);
