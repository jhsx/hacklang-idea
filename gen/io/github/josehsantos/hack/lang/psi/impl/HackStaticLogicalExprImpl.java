...
public class HackStaticLogicalExprImpl extends ASTWrapperPsiElement implements HackStaticLogicalExpr {

  public HackStaticLogicalExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitStaticLogicalExpr(this);
