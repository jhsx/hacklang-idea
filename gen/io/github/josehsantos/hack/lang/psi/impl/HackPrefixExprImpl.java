...
public class HackPrefixExprImpl extends ASTWrapperPsiElement implements HackPrefixExpr {

  public HackPrefixExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitPrefixExpr(this);
