...
public class HackExpressionStatementImpl extends HackBaseStatementImpl implements HackExpressionStatement {

  public HackExpressionStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitExpressionStatement(this);
  ...
  @Override
  @Nullable
  public HackAwaitAssignExpression getAwaitAssignExpression() {
    return findChildByClass(HackAwaitAssignExpression.class);
  }

  @Override
  @Nullable
  public HackAwaitExpression getAwaitExpression() {
    return findChildByClass(HackAwaitExpression.class);
  }

  @Override
  @Nullable
  public HackAwaitListAssignExpression getAwaitListAssignExpression() {
    return findChildByClass(HackAwaitListAssignExpression.class);
  }
  ...
  @Override
  @Nullable
  public HackQueryAssignExpression getQueryAssignExpression() {
    return findChildByClass(HackQueryAssignExpression.class);
  }
  ...
  @Override
  @Nullable
  public HackYieldAssignExpression getYieldAssignExpression() {
    return findChildByClass(HackYieldAssignExpression.class);
  }

  @Override
  @Nullable
  public HackYieldExpression getYieldExpression() {
    return findChildByClass(HackYieldExpression.class);
  }

  @Override
  @Nullable
  public HackYieldListAssignExpression getYieldListAssignExpression() {
    return findChildByClass(HackYieldListAssignExpression.class);
  }
