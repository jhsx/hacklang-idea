...
public class HackInternalEvalExprImpl extends ASTWrapperPsiElement implements HackInternalEvalExpr {

  public HackInternalEvalExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitInternalEvalExpr(this);
