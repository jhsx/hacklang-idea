...
public class HackLambdaFunctionImpl extends HackFunctionImpl implements HackLambdaFunction {

  public HackLambdaFunctionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitLambdaFunction(this);
