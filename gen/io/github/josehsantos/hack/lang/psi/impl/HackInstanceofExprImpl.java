...
public class HackInstanceofExprImpl extends ASTWrapperPsiElement implements HackInstanceofExpr {

  public HackInstanceofExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitInstanceofExpr(this);
  ...
  @Override
  @Nullable
  public HackCastExpr getCastExpr() {
    return findChildByClass(HackCastExpr.class);
  }
