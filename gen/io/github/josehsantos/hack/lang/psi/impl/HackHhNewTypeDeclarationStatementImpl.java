...
public class HackHhNewTypeDeclarationStatementImpl extends ASTWrapperPsiElement implements HackHhNewTypeDeclarationStatement {

  public HackHhNewTypeDeclarationStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitHhNewTypeDeclarationStatement(this);
