...
public class HackInternalRequireExprImpl extends ASTWrapperPsiElement implements HackInternalRequireExpr {

  public HackInternalRequireExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitInternalRequireExpr(this);
