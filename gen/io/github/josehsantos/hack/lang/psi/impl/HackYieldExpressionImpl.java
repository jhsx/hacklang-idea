...
public class HackYieldExpressionImpl extends HackExpressionImpl implements HackYieldExpression {

  public HackYieldExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitYieldExpression(this);
