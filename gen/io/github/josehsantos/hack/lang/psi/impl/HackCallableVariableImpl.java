...
public class HackCallableVariableImpl extends ASTWrapperPsiElement implements HackCallableVariable {

  public HackCallableVariableImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitCallableVariable(this);
