...
public class HackInternalEmptyExprImpl extends ASTWrapperPsiElement implements HackInternalEmptyExpr {

  public HackInternalEmptyExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitInternalEmptyExpr(this);
