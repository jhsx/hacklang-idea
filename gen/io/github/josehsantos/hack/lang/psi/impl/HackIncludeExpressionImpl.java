...
public class HackIncludeExpressionImpl extends HackExpressionImpl implements HackIncludeExpression {

  public HackIncludeExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitIncludeExpression(this);
