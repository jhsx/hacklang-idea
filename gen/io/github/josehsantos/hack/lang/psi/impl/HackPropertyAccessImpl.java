...
public class HackPropertyAccessImpl extends ASTWrapperPsiElement implements HackPropertyAccess {

  public HackPropertyAccessImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitPropertyAccess(this);
