...
public class HackNewTypeStatementImpl extends HackStatementImpl implements HackNewTypeStatement {

  public HackNewTypeStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitNewTypeStatement(this);
