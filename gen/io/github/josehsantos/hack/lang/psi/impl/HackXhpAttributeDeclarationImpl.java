...
public class HackXhpAttributeDeclarationImpl extends HackPsiElementImpl implements HackXhpAttributeDeclaration {

  public HackXhpAttributeDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitXhpAttributeDeclaration(this);
  ...
  @Override
  @Nullable
  public HackXhpAttributeType getXhpAttributeType() {
    return findChildByClass(HackXhpAttributeType.class);
  }
