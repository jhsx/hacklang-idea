...
public class HackHhNameWithTypeImpl extends ASTWrapperPsiElement implements HackHhNameWithType {

  public HackHhNameWithTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitHhNameWithType(this);
