...
public class HackTraitStatementImpl extends HackStatementImpl implements HackTraitStatement {

  public HackTraitStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitTraitStatement(this);
