...
public class HackNewExpressionImpl extends HackExpressionImpl implements HackNewExpression {

  public HackNewExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitNewExpression(this);
