...
public class HackDimExpressionBaseImpl extends HackPsiElementImpl implements HackDimExpressionBase {

  public HackDimExpressionBaseImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitDimExpressionBase(this);
