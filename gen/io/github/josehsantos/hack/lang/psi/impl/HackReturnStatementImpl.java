...
public class HackReturnStatementImpl extends HackBaseStatementImpl implements HackReturnStatement {

  public HackReturnStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitReturnStatement(this);
  ...
  public HackQueryExpression getQueryExpression() {
    return findChildByClass(HackQueryExpression.class);
  }
