...
public class HackParenthesizedExprImpl extends ASTWrapperPsiElement implements HackParenthesizedExpr {

  public HackParenthesizedExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitParenthesizedExpr(this);
