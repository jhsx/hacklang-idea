...
public class HackDimmableVariableAccessExprImpl extends ASTWrapperPsiElement implements HackDimmableVariableAccessExpr {

  public HackDimmableVariableAccessExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitDimmableVariableAccessExpr(this);
