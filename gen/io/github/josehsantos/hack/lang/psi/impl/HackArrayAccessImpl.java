...
public class HackArrayAccessImpl extends ASTWrapperPsiElement implements HackArrayAccess {

  public HackArrayAccessImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitArrayAccess(this);
  ...
  public HackArrayOffsetAccess getArrayOffsetAccess() {
    return findChildByClass(HackArrayOffsetAccess.class);
  }
