...
public class HackLambdaBodyImpl extends HackPsiElementImpl implements HackLambdaBody {

  public HackLambdaBodyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitLambdaBody(this);
