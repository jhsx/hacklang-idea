...
public class HackListAssignmentExpressionImpl extends HackExpressionImpl implements HackListAssignmentExpression {

  public HackListAssignmentExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitListAssignmentExpression(this);
  ...
  public HackListAssignmentVariables getListAssignmentVariables() {
    return findChildByClass(HackListAssignmentVariables.class);
  }
