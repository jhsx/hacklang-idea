...
public class HackMethodCallExprImpl extends ASTWrapperPsiElement implements HackMethodCallExpr {

  public HackMethodCallExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitMethodCallExpr(this);
