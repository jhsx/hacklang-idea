...
public class HackHhOptReturnTypeImpl extends ASTWrapperPsiElement implements HackHhOptReturnType {

  public HackHhOptReturnTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitHhOptReturnType(this);
