...
public class HackContinueStatementImpl extends HackBaseStatementImpl implements HackContinueStatement {

  public HackContinueStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitContinueStatement(this);
