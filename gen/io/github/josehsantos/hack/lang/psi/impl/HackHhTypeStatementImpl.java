...
public class HackHhTypeStatementImpl extends ASTWrapperPsiElement implements HackHhTypeStatement {

  public HackHhTypeStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitHhTypeStatement(this);
