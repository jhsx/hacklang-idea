...
public class HackArrayPairImpl extends HackPsiElementImpl implements HackArrayPair {

  public HackArrayPairImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitArrayPair(this);
