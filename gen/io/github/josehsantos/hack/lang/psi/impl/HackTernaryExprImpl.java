...
public class HackTernaryExprImpl extends ASTWrapperPsiElement implements HackTernaryExpr {

  public HackTernaryExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitTernaryExpr(this);
