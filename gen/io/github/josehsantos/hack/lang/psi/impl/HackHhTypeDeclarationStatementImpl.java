...
public class HackHhTypeDeclarationStatementImpl extends ASTWrapperPsiElement implements HackHhTypeDeclarationStatement {

  public HackHhTypeDeclarationStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitHhTypeDeclarationStatement(this);
