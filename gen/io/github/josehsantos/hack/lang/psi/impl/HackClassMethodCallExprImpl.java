...
public class HackClassMethodCallExprImpl extends ASTWrapperPsiElement implements HackClassMethodCallExpr {

  public HackClassMethodCallExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitClassMethodCallExpr(this);
