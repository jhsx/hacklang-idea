...
public class HackForStatementBodyImpl extends ASTWrapperPsiElement implements HackForStatementBody {

  public HackForStatementBodyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitForStatementBody(this);
  ...
  @Override
  @Nullable
  public HackForNewStatement getForNewStatement() {
    return findChildByClass(HackForNewStatement.class);
  }
