...
public class HackHhNullableTypeImpl extends ASTWrapperPsiElement implements HackHhNullableType {

  public HackHhNullableTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitHhNullableType(this);
