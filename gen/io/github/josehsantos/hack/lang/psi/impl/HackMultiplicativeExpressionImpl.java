...
public class HackMultiplicativeExpressionImpl extends HackExpressionImpl implements HackMultiplicativeExpression {

  public HackMultiplicativeExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitMultiplicativeExpression(this);
