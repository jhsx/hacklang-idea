...
public class HackAssignmentExprImpl extends ASTWrapperPsiElement implements HackAssignmentExpr {

  public HackAssignmentExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitAssignmentExpr(this);
