...
public class HackExpressionVariableImpl extends HackPsiElementImpl implements HackExpressionVariable {

  public HackExpressionVariableImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitExpressionVariable(this);
