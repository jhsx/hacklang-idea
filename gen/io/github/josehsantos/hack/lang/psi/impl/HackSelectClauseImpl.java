...
public class HackSelectClauseImpl extends ASTWrapperPsiElement implements HackSelectClause {

  public HackSelectClauseImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitSelectClause(this);
