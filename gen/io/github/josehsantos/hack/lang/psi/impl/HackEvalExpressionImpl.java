...
public class HackEvalExpressionImpl extends HackExpressionImpl implements HackEvalExpression {

  public HackEvalExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitEvalExpression(this);
