...
public class HackXhpAttributesImpl extends ASTWrapperPsiElement implements HackXhpAttributes {

  public HackXhpAttributesImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitXhpAttributes(this);
