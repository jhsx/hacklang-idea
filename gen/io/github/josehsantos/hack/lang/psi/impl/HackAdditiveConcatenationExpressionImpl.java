...
public class HackAdditiveConcatenationExpressionImpl extends HackExpressionImpl implements HackAdditiveConcatenationExpression {

  public HackAdditiveConcatenationExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitAdditiveConcatenationExpression(this);
