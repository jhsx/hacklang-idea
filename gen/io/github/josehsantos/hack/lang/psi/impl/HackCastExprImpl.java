...
public class HackCastExprImpl extends ASTWrapperPsiElement implements HackCastExpr {

  public HackCastExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitCastExpr(this);
