...
public class HackVariableExpressionVariableImpl extends HackPsiElementImpl implements HackVariableExpressionVariable {

  public HackVariableExpressionVariableImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitVariableExpressionVariable(this);
