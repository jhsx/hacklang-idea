...
public class HackHhNewTypeStatementImpl extends ASTWrapperPsiElement implements HackHhNewTypeStatement {

  public HackHhNewTypeStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitHhNewTypeStatement(this);
