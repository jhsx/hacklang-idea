...
public class HackClassVariableDeclarationsImpl extends ASTWrapperPsiElement implements HackClassVariableDeclarations {

  public HackClassVariableDeclarationsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitClassVariableDeclarations(this);
  ...
  public HackVariableModifiers getVariableModifiers() {
    return findChildByClass(HackVariableModifiers.class);
  }
