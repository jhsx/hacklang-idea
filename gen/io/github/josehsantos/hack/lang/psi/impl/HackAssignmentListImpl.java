...
public class HackAssignmentListImpl extends HackPsiElementImpl implements HackAssignmentList {

  public HackAssignmentListImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitAssignmentList(this);
  ...
  @Override
  @NotNull
  public List<HackListAssignmentVariables> getListAssignmentVariablesList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, HackListAssignmentVariables.class);
  }
