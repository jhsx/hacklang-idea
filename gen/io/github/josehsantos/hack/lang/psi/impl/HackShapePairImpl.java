...
public class HackShapePairImpl extends HackPsiElementImpl implements HackShapePair {

  public HackShapePairImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitShapePair(this);
  ...
  public HackShapeKeyName getShapeKeyName() {
    return findChildByClass(HackShapeKeyName.class);
  }
