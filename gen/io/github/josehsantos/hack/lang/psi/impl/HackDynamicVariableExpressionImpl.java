...
public class HackDynamicVariableExpressionImpl extends HackExpressionImpl implements HackDynamicVariableExpression {

  public HackDynamicVariableExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitDynamicVariableExpression(this);
