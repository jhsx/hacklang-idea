...
public class HackStaticMultiplicativeExpressionImpl extends HackExpressionImpl implements HackStaticMultiplicativeExpression {

  public HackStaticMultiplicativeExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitStaticMultiplicativeExpression(this);
