...
public class HackAwaitExpressionImpl extends HackExpressionImpl implements HackAwaitExpression {

  public HackAwaitExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitAwaitExpression(this);
