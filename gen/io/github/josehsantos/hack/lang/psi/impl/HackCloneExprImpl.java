...
public class HackCloneExprImpl extends ASTWrapperPsiElement implements HackCloneExpr {

  public HackCloneExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HackVisitor) ((HackVisitor)visitor).visitCloneExpr(this);
