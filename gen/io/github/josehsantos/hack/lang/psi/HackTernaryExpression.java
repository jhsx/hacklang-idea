...
public interface HackTernaryExpression extends HackExpression {
  ...
  @NotNull
  List<HackLogicalExpression> getLogicalExpressionList();
  ...
  @NotNull
  List<HackTernaryExpression> getTernaryExpressionList();
