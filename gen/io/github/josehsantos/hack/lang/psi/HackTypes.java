...
public interface HackTypes {
  ...
  IElementType CALLABLE_FUNCTION_CALL_EXPR = new HackTokenType("CALLABLE_FUNCTION_CALL_EXPR");
  ...
  IElementType CLASS_METHOD_CALL_EXPR = new HackTokenType("CLASS_METHOD_CALL_EXPR");
  ...
  IElementType DIMMABLE_VARIABLE_ACCESS_EXPR = new HackTokenType("DIMMABLE_VARIABLE_ACCESS_EXPR");
  ...
  IElementType ESPECIAL_PARENTHESISED_EXPR = new HackTokenType("ESPECIAL_PARENTHESISED_EXPR");
  ...
  IElementType HH_NEW_TYPE_DECLARATION_STATEMENT = new HackTokenType("HH_NEW_TYPE_DECLARATION_STATEMENT");
  ...
  IElementType HH_TYPE_DECLARATION_STATEMENT = new HackTokenType("HH_TYPE_DECLARATION_STATEMENT");
  ...
  IElementType MEMBER_VARIABLE_EXPR = new HackTokenType("MEMBER_VARIABLE_EXPR");
  IElementType METHOD_CALL_EXPR = new HackTokenType("METHOD_CALL_EXPR");
  ...
  IElementType SIMPLE_FUNCTION_CALL_EXPR = new HackTokenType("SIMPLE_FUNCTION_CALL_EXPR");
  ...
  IElementType STATIC_CLASS_VARIABLE_EXPR = new HackTokenType("STATIC_CLASS_VARIABLE_EXPR");
  ...
  IElementType VARIABLE_WITHOUT_OBJECTS_EXPR = new HackTokenType("VARIABLE_WITHOUT_OBJECTS_EXPR");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      IElementType type = node.getElementType();
       if (type == ADDITIVE_OR_CONCATENATION_EXPR) {
      ...
      else if (type == CALLABLE_FUNCTION_CALL_EXPR) {
        return new HackCallableFunctionCallExprImpl(node);
      }
      ...
      else if (type == CLASS_METHOD_CALL_EXPR) {
        return new HackClassMethodCallExprImpl(node);
      }
      ...
      else if (type == DIMMABLE_VARIABLE_ACCESS_EXPR) {
        return new HackDimmableVariableAccessExprImpl(node);
      }
      ...
      else if (type == ESPECIAL_PARENTHESISED_EXPR) {
        return new HackEspecialParenthesisedExprImpl(node);
      }
      ...
      else if (type == HH_NEW_TYPE_DECLARATION_STATEMENT) {
        return new HackHhNewTypeDeclarationStatementImpl(node);
      }
      ...
      else if (type == HH_TYPE_DECLARATION_STATEMENT) {
        return new HackHhTypeDeclarationStatementImpl(node);
      }
      ...
      else if (type == MEMBER_VARIABLE_EXPR) {
        return new HackMemberVariableExprImpl(node);
      }
      else if (type == METHOD_CALL_EXPR) {
        return new HackMethodCallExprImpl(node);
      }
      ...
      else if (type == SIMPLE_FUNCTION_CALL_EXPR) {
        return new HackSimpleFunctionCallExprImpl(node);
      }
      ...
      else if (type == STATIC_CLASS_VARIABLE_EXPR) {
        return new HackStaticClassVariableExprImpl(node);
      }
      ...
      else if (type == VARIABLE_WITHOUT_OBJECTS_EXPR) {
        return new HackVariableWithoutObjectsExprImpl(node);
      }
