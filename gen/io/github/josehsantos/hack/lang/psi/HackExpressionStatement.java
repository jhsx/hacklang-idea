...
public interface HackExpressionStatement extends HackBaseStatement {
  ...
  @Nullable
  HackAwaitAssignExpression getAwaitAssignExpression();

  @Nullable
  HackAwaitExpression getAwaitExpression();

  @Nullable
  HackAwaitListAssignExpression getAwaitListAssignExpression();
  ...
  @Nullable
  HackQueryAssignExpression getQueryAssignExpression();
  ...
  @Nullable
  HackYieldAssignExpression getYieldAssignExpression();

  @Nullable
  HackYieldExpression getYieldExpression();

  @Nullable
  HackYieldListAssignExpression getYieldListAssignExpression();
